...
public class ClientePJ extends Cliente {
	...
	//Constructor
	public ClientePJ (String cnpj, LocalDate dataFundacao, String nome, String endereco, int qtdeFuncionarios){
	...
	public double calculaScore() {
		return 100.0 * (1 + (this.qtdeFuncionarios)/100) * this.getListaVeiculos().size();
	}
}